...
{
    [Route("[controller]")]
    public class Feature1WithoutAAController : BaseController
    {
        public Feature1WithoutAAController(IHttpContextAccessor contextAccessor)
        ...
        //[HttpGet("GetDataWithRequiredRoute/{param1}/{param2}/{param3}", Name = "Feature1GetDataWithRequiredRoute")]
        [HttpGet]
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(string))]
        //[HttpGet("GetDataWithQueryString", Name = "Feature1GetDataWithQueryString")]
        [HttpGet]
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(string))]
        //[HttpGet("GetDataWithRequiredAndOptionalRoute/{param1}/{param2?}/{param3?}/{param4?}", Name = "Feature1GetDataWithRequiredAndOptionalRoute")]
        [HttpGet]
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(string))]
        //[HttpGet("GetDataWithOptionalRoute/{param1?}/{param2?}/{param3?}", Name = "Feature1GetDataWithOptionalRoute")]
        [HttpGet]
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(string))]
        //[HttpGet("GetDataWithRequiredAndOptionalRouteAndQueryString/{param1}/{param2?}/{param3?}/{param4?}", Name = "Feature1GetDataWithRequiredAndOptionalRouteAndQueryString")]
        [HttpGet]
